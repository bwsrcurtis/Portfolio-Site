function light_dark() {
    let aboutImgLight = document.querySelector('.img-about-light');
    let aboutImgDark = document.querySelector('.img-about-dark');
    ...
    if (light === "true") {
        ...
        aboutImgLight.style.setProperty("display", "none");
        aboutImgDark.style.setProperty("display", "inline");
        ...
        aboutImgLight.style.setProperty("display", "inline");
        aboutImgDark.style.setProperty("display", "none");
